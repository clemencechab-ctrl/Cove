...
app.use(helmet({
    contentSecurityPolicy: {
        ...
        directives: {
            defaultSrc: ["'self'"],
            scriptSrc: ["'self'", "'unsafe-inline'", "https://www.gstatic.com", "https://apis.google.com", "https://gc.zgo.at"],
            ...
            frameSrc: ["'self'", "https://covestudio.firebaseapp.com", "https://accounts.google.com", "https://apis.google.com"],
            objectSrc: ["'none'"],
            baseUri: ["'self'"],
            formAction: ["'self'"],
            frameAncestors: ["'self'"]
